...
public:
    ...
    SingleLinkedList& operator=(const SingleLinkedList& rhs) {
        if (head_.next_node == rhs.head_.next_node) { return *this; }
    ...
    void Clear() noexcept {
        ...
        while (head_.next_node != nullptr) {
            temp = head_.next_node->next_node;
            delete head_.next_node;
            head_.next_node = temp;
        }
        size_ = 0;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        if (pos.node_->next_node == nullptr) { return this->end(); }

        Node* after_pos_item = pos.node_->next_node->next_node;
        delete pos.node_->next_node;
        pos.node_->next_node = after_pos_item;

        --size_;
        return Iterator(after_pos_item);
    }
